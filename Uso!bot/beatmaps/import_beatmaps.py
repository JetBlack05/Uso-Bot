...
downloadDirr = "/root/UsoBot/beatmaps/permanent"
databaseDirr = "/root/UsoBot/Database.db"
		...
		if Pass == False:
			...
			if beatmap_info['mode'] == OsuMode.osu:
				...
				for accuracy in accuracys:
					...
					for mod in mods:
						pyoppai.parse(downloadDirr + "/" + beatmap, b, buf, BUFSIZE, False, downloadDirr)
						...
						try:
							...
							data.append(2147483647) #max sqlite int 4 bytes value
